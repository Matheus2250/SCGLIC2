...
import { Box, Grid, Paper, Typography, Card, CardContent, Alert, CircularProgress } from '@mui/material';
import { CheckCircle, HourglassEmpty, Assignment } from '@mui/icons-material';
...
const EstatisticasQualificacao: React.FC = () => {
  ...
  return (
    <Box>
      <Typography variant="h4" sx={{ mb: 3 }}>Estatísticas da Qualificação</Typography>
          ...
          <Card>
            <CardContent sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="textSecondary">Total de Qualificações</Typography>
              </Box>
            </CardContent>
          </Card>
        </Grid>
          ...
          <Card>
            <CardContent sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="textSecondary">Em Análise</Typography>
              </Box>
            </CardContent>
          </Card>
        </Grid>
      ...
      {qualificacoes.length > 0 ? (
        <Paper sx={{ p: 4 }}>
          <Typography variant="h6" sx={{ mb: 2 }}>Resumo das Qualificações</Typography>
        ...
        <Paper sx={{ p: 4, textAlign: 'center' }}>
          <Typography variant="h6" color="textSecondary">Estatísticas da Qualificação</Typography>
          <Typography variant="body1" color="textSecondary" sx={{ mt: 2 }}>
            Nenhuma qualificação encontrada no sistema. As estatísticas aparecerão quando qualificações forem cadastradas.
          </Typography>
        </Paper>
      )}
    </Box>
