...
- [ ] Criar sistema para envio automático de e-mails:
  - Envio de alertas às áreas demandantes sobre contratações atrasadas  
  - Envio de e-mails automáticos com informações importantes (ex: contratações próximas do vencimento)  
- [ ] Implementar login via conta Microsoft/Outlook (`@saude.gov.br`)  
- [ ] Permitir o acesso aos e-mails do usuário (com permissão) para:
  - Personalizar a área inicial do sistema  
  - Exibir e-mails recentes no dashboard  